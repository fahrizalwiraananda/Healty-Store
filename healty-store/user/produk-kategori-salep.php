...
<body id="body">
                ...
                <ul class="navbar-nav ms-auto" style="font-size: 12px;">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu active" aria-labelledby="navbarDropdown" style="font-size: 11px;">
                          ...
                          <li><a class="dropdown-item salep" href="produk-kategori-salep.php">Salep</a></li>     
    ...
    <!--End Breadcump-->
        ...
        <div class="container mt-3 row-bagr" id="produk-container">
            ...
            <?php $ambil = $conn->query("SELECT * FROM produk WHERE kategori = 'salep'"); ?>
