...
<head>
    ...
    <title>Produk Obat Tablet</title>
...
<body id="body">
                ...
                <ul class="navbar-nav ms-auto" style="font-size: 12px;">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown" style="font-size: 11px;">
                          ...
                          <li><a class="dropdown-item active" href="produk-kategori-tablet.php">Tablet</a></li>
    ...
    <!--End Breadcump-->
        ...
        <div class="container mt-3 row-bagr" id="produk-container">
            ...
            <h8 class="text-center"><strong>Produk Obat Tablet</strong></h8>

            <div class="row" style="padding: 15px;">

            <?php $ambil = $conn->query("SELECT * FROM produk WHERE kategori = 'tablet'"); ?>
