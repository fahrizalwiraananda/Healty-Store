...
<head>
    ...
    <title>Produk Obat Produk Lain</title>
...
<body id="body">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto" style="font-size: 12px;">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu active" aria-labelledby="navbarDropdown" style="font-size: 11px;">
                          <li><a class="dropdown-item" href="produk-kategori-sirup.php">Sirup</a></li>
                          ...
                          <li><a class="dropdown-item active" href="produk-kategori-produk.php">Produk Lain</a></li>
                        </ul>
                      </li>
                      <li class="nav-item">
    ...
    <div class="container ps-0 pe-0">
        <nav aria-label="breadcrumb" class="mt-3" style="background-color: #fff;;">
            <ol class="breadcrumb p-3">
              <li class="breadcrumb-item active" aria-current="page">Halaman Kategori Produk</li>
            </ol>
          </nav>
    </div>
    ...
    <!--End Breadcump-->
        ...
        <div class="container mt-3 row-bagr" id="produk-container">
            ...
            <h8 class="text-center"><strong>Produk Obat Produk Lain</strong></h8>

            <div class="row" style="padding: 15px;">

            <?php $ambil = $conn->query("SELECT * FROM produk WHERE kategori = 'produk lain'"); ?>
                    ...
                    <div class="card text-center" id="card-hover">
                        <form action="">
                            <a href="produk-detail.php?id=<?php echo $perproduk['id_produk']; ?>">
                                <img src="../assets/produk/<?php echo $perproduk['foto_produk']; ?>" class="card-img-top" alt="Insto">
                            </a>
                            <div class="card-body">
